  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <form.Field name="confirmPassword" validators={{ onChange: schema.shape.confirmPassword }}>
          {(field) => (
            <div className="space-y-2">
      ...
      <form.Field name="termsAccepted" validators={{ onChange: schema.shape.termsAccepted }}>
        {(field) => (
